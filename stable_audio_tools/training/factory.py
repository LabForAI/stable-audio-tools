...
def create_training_wrapper_from_config(model_config, model, args):
    ...
    if model_type == "autoencoder":
        ...
        if model_config["model_type"] == "autoencoder" and args.accum_batches:
            kwargs["gradient_accumulation"] = args.accum_batches
